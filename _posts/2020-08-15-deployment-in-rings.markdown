...
|------|----------------------------|--------------------------------------------|---|---|
| 0    | Developer machine          | unit tests, functional tests, manual tests |   |   |
| 1    | Staging/release environmen | integration testing                        |   |   |
| 2    | Production preview         | Tip (testing in production)                |   |   |