...
## Architecture: share-nothing by construction
...
## Performance: the numbers, including the bad ones
...
The code, specs, and measured performance notes are all public at [github.com/nobelk/llmsim](https://github.com/nobelk/llmsim), with full documentation at [outloop.blog/llmsim](https://outloop.blog/llmsim/).
